...
public class AmberTradeService extends AmberTradeServiceRaw implements TradeService {

  public AmberTradeService(Exchange exchange) {
    super(exchange);
  }
  ...
  public String placeLimitOrder(LimitOrder limitOrder) throws IOException {
    ...
    return AmberAdapters.adaptTradeAdd(getCoinEggTradeAdd(amount, price, type, coin));
  }
  ...
  public boolean cancelOrder(CancelOrderParams orderParams) throws IOException {
    ...
    if ((orderParams instanceof CancelOrderByIdParams)
      ...
      return AmberAdapters.adaptTradeCancel(getCoinEggTradeCancel(id, coin));
    }
  ...
  public UserTrades getTradeHistory(TradeHistoryParams params)
    ...
    if ((params instanceof TradeHistoryParamCurrency)
      ...
      return AmberAdapters.adaptTradeHistory(getCoinEggTradeView(tradeID, coin));
    }
